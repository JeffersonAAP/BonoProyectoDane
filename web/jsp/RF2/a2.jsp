<%-- 
    Document   : a2
    Created on : 17/06/2021, 02:14:25 PM
    Author     : JeAnA
--%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card text-center">
                <div class="card-body">
                    <p>Escoja el departamento al cuál desea consultar su información:</p>
                    <form class="form-horizontal" action="ReadDptoa2.do" method="POST">
                        <div class="row">
